...
const categories = ['All', 'E-Commerce', 'Travel', 'Education', 'Business', 'Platform'];
...
function ProjectVisual({ url, title, color }: { url: string; title: string; color: string }) {
          ...
          {filtered.map((item, i) => (
            ...
            >
              <a href={item.url} target="_blank" rel="noopener noreferrer" aria-label={`Visit ${item.title}`}>
                <ProjectVisual url={item.url} title={item.title} color={item.color} />
              </a>
