...
const defaultMission = {
  title: 'Our Mission',
  body: 'Help ambitious businesses modernize how they operate and how they show up online â€” without juggling five agencies. From AI systems and cloud infrastructure to social media, reels, and paid ads, we take ownership end-to-end so you can focus on running the business.',
};

const defaultCta = {
  title: "Let's Build Something Together",
  body: "Whether you need AI agents, a new product, or a full marketing engine â€” we're ready.",
  button: 'Get in Touch',
};
...
const pillars = [
  {
    icon: Code2,
    title: 'Technology',
    desc: 'AI agents, software, mobile apps, cloud, and UX â€” engineered for production, not demos.',
  },
  {
    icon: Megaphone,
    title: 'Marketing',
    desc: 'Social, content, SEO, ads, and branding â€” managed end-to-end so you can focus on the business.',
  },
  {
    icon: Target,
    title: 'Outcomes',
      ...
      <main className="pt-28 pb-20 px-5 sm:px-8 max-w-7xl mx-auto">
        ...
        <div className="mb-12 md:mb-24">
          ...
          <p className="text-slate-400 mb-10 max-w-xl">
            Placeholder profiles for now â€” swap in real photos anytime by adding an image path to each card.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {team.map((member, i) => (
              ...
              >
                {/* Avatar â€” replace with <img src={member.image} /> when ready */}
                <div
